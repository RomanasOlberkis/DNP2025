...
public class CommentFileRepository : ICommentRepository
{
    ...
    public async Task UpdateAsync(Comment comment)
    {
        ...
        {
            throw new InvalidOperationException($"Comment with ID '{comment.Id}' not found in comment list");
        }
    ...
    public async Task DeleteAsync(int id)
    {
        ...
        {
            throw new InvalidOperationException($"Comment with ID '{id}' not found in the comment list");
        }
    ...
    public async Task<Comment> GetSingleAsync(int id)
    {
        ...
        if (comment is null)
        {
            throw new InvalidOperationException($"Comment with ID '{id}' not found in the coment list");
        }
        return comment;
    }
